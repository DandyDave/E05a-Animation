...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        for i in range(COIN_COUNT):
            ...
            coin.textures = []
            coin.textures.append(arcade.load_texture("images/goldCoin1.png", scale=COIN_SCALE))
            coin.textures.append(arcade.load_texture("images/goldCoin2.png", scale=COIN_SCALE))
            coin.textures.append(arcade.load_texture("images/goldCoin3.png", scale=COIN_SCALE))
            coin.textures.append(arcade.load_texture("images/goldCoin4.png", scale=COIN_SCALE))
            coin.textures.append(arcade.load_texture("images/goldCoin5.png", scale=COIN_SCALE))
            coin.textures.append(arcade.load_texture("images/goldCoin6.png", scale=COIN_SCALE))
            coin.textures.append(arcade.load_texture("images/goldCoin7.png", scale=COIN_SCALE))
            coin.textures.append(arcade.load_texture("images/goldCoin8.png", scale=COIN_SCALE))
            coin.textures.append(arcade.load_texture("images/goldCoin9.png", scale=COIN_SCALE))
